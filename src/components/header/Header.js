      ...
      <header>
        ...
        <nav>
          <ul>
            ...
            <li>
              <NavLink activeStyle={{ boxShadow: "0px 4px 4px rgba(0, 0, 0, .6),0 -1px 3px rgba(255, 255, 255, .6)", backgroundColor: "rgb(94, 46, 228)" }} className="nav-link" to="/gallery">Gallery</NavLink>
            </li>
            <li>
